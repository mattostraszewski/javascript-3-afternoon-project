...
//FILTER PUSHES TRUE VALUES TO NEW ARRAY AND DOESN'T PUSH FALSE VALUES. 
let evenNumbers = mixedNumbers.filter(element => { //FILTER RUNS OVER THE WHOLE FUNCTION AND RETURNS A NEW ARRAY. 
  return element % 2 == 0
})
...
// MAP TAKES IN AN ARRAY, RUNS OVER MY ARRAY AND RETURNS THE SAME ARRAY!!!!!!
...
//Code Here
let totalPopulation = populations.reduce((acc, value) => {
  return acc + value
}, 0)
...
let bobsTotal = purchases.reduce((acc, value) => {
  if (value.owner == 'Bob') {
